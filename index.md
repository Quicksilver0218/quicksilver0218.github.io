...
- [React-Tokenized-Input](https://github.com/Quicksilver0218/React-Tokenized-Input){:target="_blank" rel="noopener"}: A React input field component that tokenizes and autocompletes the input.
...
- [FPS-QR-Code-Generator](https://github.com/Quicksilver0218/FPS-QR-Code-Generator){:target="_blank" rel="noopener"}: A web-based Faster Payment System (FPS) (快速支付系統) (轉數快) QR code generator.
- [Unity-Maze](https://github.com/Quicksilver0218/Unity-Maze){:target="_blank" rel="noopener"}: A simple maze game made with Unity.
- [Windows 10 Update Screen](/windows-10-update-screen){:target="_blank" rel="noopener"}: A mock update screen of Windows 10 in web UI.
...
- [Image-Shrinker](https://image-shrinker.vercel.app){:target="_blank" rel="noopener"}: An online service for creating thumbnails of online images.
